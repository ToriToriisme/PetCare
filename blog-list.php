...
<main class="blog-list">
  ...
  ?>
  <div class="blog-item">
    <img src="assets/img/blog/blog1.png" alt="<?= htmlspecialchars($b['title']) ?>">
    <div class="content">
      ...
      <a href="blog.php?id=<?= $b['id'] ?>" class="read-more">Xem chi tiết →</a>
    </div>
  </div>
  <?php endforeach; ?>
...
if(isset($_GET['id'])){
  $id = intval($_GET['id']);
  $post = getRow("SELECT * FROM blogs WHERE id=$id");
  if($post):
?>
