<?php
include_once('../config/db.php'); // Chỉ include_once để tránh include nhiều lần
...
<?php 
$isGuestPage = true; // Đây là trang guest
...
<section class="banner-new">
  <div class="container banner-content">
    <div class="banner-text">
      ...
      <!-- Nút hiển thị dựa vào trạng thái login -->
      <?php if($isLoggedIn): ?>
        <a href="booking.php" class="btn primary-btn">ĐẶT LỊCH NGAY</a>
      <?php else: ?>
        <a href="login.php" class="btn primary-btn">ĐĂNG NHẬP / ĐĂNG KÝ</a>
      <?php endif; ?>
    </div>
    ...
    <div class="container">
      ...
      <div class="grid promotion-grid-new">
        <div class="promo-card-new">
          ...
          <?php if($isLoggedIn): ?>
            <a href="booking.php" class="btn primary-btn small-btn full-width">ĐĂNG KÝ NGAY</a>
          <?php else: ?>
            <a href="login.php" class="btn primary-btn small-btn full-width">ĐĂNG KÝ NGAY</a>
          <?php endif; ?>
        </div>
      ...
      <div class="grid ending-promo-grid">
        <div class="ending-promo-card">
          ...
          <div class="ending-countdown">
            ...
            <span class="countdown-time">02:18:37</span>
          </div>
        </div>
        <div class="ending-promo-card">
          <div class="ending-card-content">
    ...
    <div class="grid doctor-grid">
      <div class="card doctor-card">
        ...
        <p>Chuyên khoa Phẫu thuật – Cấp cứu, Chẩn đoán hình ảnh (Siêu âm, X-Quang). Phụ trách xử lý các ca ngoại khoa và cấp cứu khẩn cấp.</p>
         <?php if($isLoggedIn): ?>
            <a href="/doctor.php" class="link">Xem hồ sơ →</a>
          <?php else: ?>
            <a href="login.php" class="link">Xem hồ sơ →</a>
          <?php endif; ?>
      </div>
